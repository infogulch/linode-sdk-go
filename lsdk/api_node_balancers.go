 ...
 * @param body17 Information about the NodeBalancer to create.
@return NodeBalancer
*/
func (a *NodeBalancersApiService) CreateNodeBalancer(ctx context.Context, body17 Body17) (NodeBalancer, *http.Response, error) {
	var (
